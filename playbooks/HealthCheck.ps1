...
$ServerListFile = "C:\servers\ServerList.txt"  
...
$Outputreport | out-file C:\servers\Test.htm 
Invoke-Expression C:\servers\Test.htm
...
$message.Body += Get-Content c:\servers\test.htm
